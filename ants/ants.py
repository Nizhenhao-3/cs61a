...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self):
        ...
        #     if not pos.is_hive and self.lower_bound<=num<=self.upper_bound:
        #         if pos.bees!=[]:
        ...
        while not pos.is_hive:
            if len(pos.bees) > 0 and self.lower_bound<=num<=self.upper_bound:
                return random_bee(pos.bees)
            else:
                pos = pos.entrance
                num+=1
...
class ScubaThrower(ThrowerAnt):
    ...
    name = 'Scuba'
    def __init__(self,health=1):
        super(ScubaThrower, self).__init__(health)
...
class QueenAnt(ThrowerAnt):
    ...
    def reduce_health(self, amount):
        ...
        self.health-=amount
        if self.health<=0:
             super(QueenAnt, self).reduce_health(0)
             return ants_lose()
        # END Problem 12
